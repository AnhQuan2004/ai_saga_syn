...
var ICONS = {
  add: async () => (await import("./add-7CVTVEMX.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-7AYVNLIU.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-GQ4YVN3L.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-ZZ3RCC75.js")).appStoreSvg,
  apple: async () => (await import("./apple-QVS5EWH5.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SFRPAQDM.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-OFGBZX44.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-ILYLS6H2.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-24V7PNY2.js")).arrowTopSvg,
  bank: async () => (await import("./bank-HGXACHGO.js")).bankSvg,
  browser: async () => (await import("./browser-HLJI666L.js")).browserSvg,
  card: async () => (await import("./card-6A6U3ZDE.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7PWYOO2B.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-Y4BJ54OB.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-JGWLBCSP.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DMVTQRAJ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-7AHUGLUU.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-LE44G2AJ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-V7AGPGYD.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-P2WA7GCB.js")).clockSvg,
  close: async () => (await import("./close-5AVC2NJG.js")).closeSvg,
  compass: async () => (await import("./compass-6EXX6SRQ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-MNGASPV6.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-N6K7DNCR.js")).copySvg,
  cursor: async () => (await import("./cursor-JIVZ5FDX.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-4JH4OMQO.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-72YIRDUG.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-WJ5BMA7P.js")).disconnectSvg,
  discord: async () => (await import("./discord-RJVMIC5P.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CD6G5VV7.js")).etherscanSvg,
  extension: async () => (await import("./extension-SLGOJ7JT.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-G6DSV4L2.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-6NZFTEYY.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-UC5ZCKZJ.js")).farcasterSvg,
  filters: async () => (await import("./filters-7N2EOOAR.js")).filtersSvg,
  github: async () => (await import("./github-RUAMPAQX.js")).githubSvg,
  google: async () => (await import("./google-ZB7KYE4A.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-YKYYF3VN.js")).helpCircleSvg,
  image: async () => (await import("./image-GUUIDBWZ.js")).imageSvg,
  id: async () => (await import("./id-7QRED2AJ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-TVVWNG4Z.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-6JODIWSQ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LBL63F3B.js")).mailSvg,
  mobile: async () => (await import("./mobile-JLZWXYW3.js")).mobileSvg,
  more: async () => (await import("./more-QNUWUA6F.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KA53Q522.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-P3I4ZQU4.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RKKCDO7T.js")).offSvg,
  playStore: async () => (await import("./play-store-LELK3KX3.js")).playStoreSvg,
  plus: async () => (await import("./plus-QZBZFTTQ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-NFXGZ7KQ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-XUFTPOK5.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-PL2YPRI5.js")).refreshSvg,
  search: async () => (await import("./search-XKNCPYCL.js")).searchSvg,
  send: async () => (await import("./send-X63F4GW2.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RZASBMIG.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-FDBGXA53.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-UL5SCNQR.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-A4TYPNO7.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-VYCDBGBK.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-HTYF3BI3.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-OPCPWBT7.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-QMTIZ7EL.js")).twitchSvg,
  twitter: async () => (await import("./x-OMRQG5M2.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-MVEMRSQF.js")).twitterIconSvg,
  verify: async () => (await import("./verify-SIIPNZ36.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-DNM477R4.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-2G3HWTSL.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-Y7TGA6EA.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-Y7TGA6EA.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-Y7TGA6EA.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-LP2JWZQM.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-R4EXBPLG.js")).warningCircleSvg,
  x: async () => (await import("./x-OMRQG5M2.js")).xSvg,
  info: async () => (await import("./info-CL6ZWCKW.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-7HO5TPG2.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-C4OY5STU.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7HRU3DPV.js.map
