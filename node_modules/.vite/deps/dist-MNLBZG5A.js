  ...
  return createConnector((config2) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK: createBaseAccountSDK2 } = await import("./dist-MNLBZG5A.js");
...
async function pay(options) {
  var _a;
  const { amount, to: to3, testnet = false, payerInfo } = options;
  const correlationId = crypto.randomUUID();
...
*/
//# sourceMappingURL=dist-MNLBZG5A.js.map
