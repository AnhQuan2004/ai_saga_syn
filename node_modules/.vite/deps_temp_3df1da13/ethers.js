...
var require_ethers_min = __commonJS({
  "node_modules/ethers/dist/ethers.min.js"(exports, module) {
    !function(e) {
      ...
      return function n(i, o, s) {
        ...
        for (var u = "function" == typeof __require && __require, e = 0; e < s.length; e++) a(s[e]);
        return a;
      }({ 1: [function(e, t, r) {
        "use strict";
        ...
        var n, i = this && this.__extends || (n = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e2, t2) {
          ...
          for (var r2 in t2) t2.hasOwnProperty(r2) && (e2[r2] = t2[r2]);
        }, function(e2, t2) {
          function r2() {
            this.constructor = e2;
          }
        ...
        function w(o2, e2, s2) {
          ...
          return function() {
            ...
            if (e3.length === a2.inputs.length + 1 && "object" == typeof e3[e3.length - 1]) {
              for (var n2 in null != (i2 = p.shallowCopy(e3.pop())).blockTag && (r2 = i2.blockTag), delete i2.blockTag, i2) if (!b[n2]) throw new Error("unknown transaction override " + n2);
            }
            if (e3.length != a2.inputs.length) throw new Error("incorrect number of arguments");
            return ["data", "to"].forEach(function(e4) {
              ...
              if ("address" === e4.type) return i3.resolveName(o3);
              if ("tuple" === e4.type) return n3(i3, o3, e4.components);
              var t3 = e4.type.match(/(.*)(\[[0-9]*\]$)/);
              if (t3) {
                if (!Array.isArray(o3)) throw new Error("invalid value for array");
              ...
              if (i2.data = a2.encode(n3), "call" === a2.type) return s2 ? Promise.resolve(u.Zero) : (o2.provider || l.throwError("call (constant functions) require a provider or a signer with a provider", l.UNSUPPORTED_OPERATION, { operation: "call" }), ["gasLimit", "gasPrice", "value"].forEach(function(e4) {
                if (null != i2[e4]) throw new Error("call cannot override " + e4);
        ...
        var M = (A.prototype.deployed = function() {
          ...
          var r2 = this;
          if ("string" == typeof e2) {
            if ("*" === e2) return { prepareEvent: function(e3) {
          ...
          if (e2.topics && e2.topics[0]) {
            for (var o2 in t2.topics = e2.topics, this.interface.events) if (-1 !== o2.indexOf("(")) {
          ...
          for (var t2 = this, r2 = [], n2 = 1; n2 < arguments.length; n2++) r2[n2 - 1] = arguments[n2];
        ...
        function A(t2, e2, r2) {
          ...
          }), this._events = [], p.defineReadOnly(this, "address", t2), this.provider) p.defineReadOnly(this, "addressPromise", this.provider.resolveName(t2).then(function(e3) {
            if (null == e3) throw new Error("name not found");
            return e3;
          }).catch(function(e3) {
            throw e3;
          }));
        ...
        E.prototype.getDeployTransaction = function() {
          ...
          if (e2.length === this.interface.deployFunction.inputs.length + 1) {
            for (var n2 in r2 = p.shallowCopy(e2.pop())) if (!b[n2]) throw new Error("unknown transaction override " + n2);
          }
          ...
          for (var r2 = this, e2 = [], t2 = 0; t2 < arguments.length; t2++) e2[t2] = arguments[t2];
        ...
        r.ethers = n, function(e2) {
          for (var t2 in e2) r.hasOwnProperty(t2) || (r[t2] = e2[t2]);
        }(e("./ethers"));
        ...
        !function(e2) {
          ...
          function n(e3) {
            if (r(e3.length)) {
              for (var t2 = 0; t2 < e3.length; t2++) if (!r(e3[t2]) || e3[t2] < 0 || 255 < e3[t2]) return;
              return 1;
            }
          }
          function o(e3, t2) {
            if (e3.buffer && ArrayBuffer.isView(e3) && "Uint8Array" === e3.name) return e3 = t2 ? e3.slice ? e3.slice() : Array.prototype.slice.call(e3) : e3;
            if (Array.isArray(e3)) {
              if (!n(e3)) throw new Error("Array contains invalid value: " + e3);
              return new Uint8Array(e3);
            }
            if (r(e3.length) && n(e3)) return new Uint8Array(e3);
          ...
          var i, t = { toBytes: function(e3) {
            ...
            for (var t2 = [], r2 = 0; r2 < e3.length; r2 += 2) t2.push(parseInt(e3.substr(r2, 2), 16));
            return t2;
          }, fromBytes: function(e3) {
          ...
          function S(e3) {
            for (var t2 = [], r2 = 0; r2 < e3.length; r2 += 4) t2.push(e3[r2] << 24 | e3[r2 + 1] << 16 | e3[r2 + 2] << 8 | e3[r2 + 3]);
            return t2;
          }
          var k = function(e3) {
          ...
          k.prototype._prepare = function() {
            ...
            if (null == e3) throw new Error("invalid key size (must be 16, 24 or 32 bytes)");
            this._Ke = [], this._Kd = [];
            for (var t2 = 0; t2 <= e3; t2++) this._Ke.push([0, 0, 0, 0]), this._Kd.push([0, 0, 0, 0]);
            for (var r2, n2 = 4 * (e3 + 1), i2 = this.key.length / 4, o2 = S(this.key), t2 = 0; t2 < i2; t2++) this._Ke[r2 = t2 >> 2][t2 % 4] = o2[t2], this._Kd[e3 - r2][t2 % 4] = o2[t2];
            for (var s2, a2 = 0, u2 = i2; u2 < n2; ) {
              if (s2 = o2[i2 - 1], o2[0] ^= d[s2 >> 16 & 255] << 24 ^ d[s2 >> 8 & 255] << 16 ^ d[255 & s2] << 8 ^ d[s2 >> 24 & 255] ^ c[a2] << 24, a2 += 1, 8 != i2) for (t2 = 1; t2 < i2; t2++) o2[t2] ^= o2[t2 - 1];
              else {
                for (t2 = 1; t2 < i2 / 2; t2++) o2[t2] ^= o2[t2 - 1];
                s2 = o2[i2 / 2 - 1], o2[i2 / 2] ^= d[255 & s2] ^ d[s2 >> 8 & 255] << 8 ^ d[s2 >> 16 & 255] << 16 ^ d[s2 >> 24 & 255] << 24;
                for (t2 = i2 / 2 + 1; t2 < i2; t2++) o2[t2] ^= o2[t2 - 1];
              }
              for (t2 = 0; t2 < i2 && u2 < n2; ) this._Ke[l2 = u2 >> 2][h2 = u2 % 4] = o2[t2], this._Kd[e3 - l2][h2] = o2[t2++], u2++;
            }
            for (var l2 = 1; l2 < e3; l2++) for (var h2 = 0; h2 < 4; h2++) s2 = this._Kd[l2][h2], this._Kd[l2][h2] = _[s2 >> 24 & 255] ^ M[s2 >> 16 & 255] ^ A[s2 >> 8 & 255] ^ E[255 & s2];
          }, k.prototype.encrypt = function(e3) {
            if (16 != e3.length) throw new Error("invalid plaintext size (must be 16 bytes)");
            for (var t2 = this._Ke.length - 1, r2 = [0, 0, 0, 0], n2 = S(e3), i2 = 0; i2 < 4; i2++) n2[i2] ^= this._Ke[0][i2];
            for (var o2 = 1; o2 < t2; o2++) {
              for (i2 = 0; i2 < 4; i2++) r2[i2] = h[n2[i2] >> 24 & 255] ^ p[n2[(i2 + 1) % 4] >> 16 & 255] ^ y[n2[(i2 + 2) % 4] >> 8 & 255] ^ m[255 & n2[(i2 + 3) % 4]] ^ this._Ke[o2][i2];
              n2 = r2.slice();
            }
            for (var s2, a2 = u(16), i2 = 0; i2 < 4; i2++) s2 = this._Ke[t2][i2], a2[4 * i2] = 255 & (d[n2[i2] >> 24 & 255] ^ s2 >> 24), a2[4 * i2 + 1] = 255 & (d[n2[(i2 + 1) % 4] >> 16 & 255] ^ s2 >> 16), a2[4 * i2 + 2] = 255 & (d[n2[(i2 + 2) % 4] >> 8 & 255] ^ s2 >> 8), a2[4 * i2 + 3] = 255 & (d[255 & n2[(i2 + 3) % 4]] ^ s2);
            return a2;
          }, k.prototype.decrypt = function(e3) {
            if (16 != e3.length) throw new Error("invalid ciphertext size (must be 16 bytes)");
            for (var t2 = this._Kd.length - 1, r2 = [0, 0, 0, 0], n2 = S(e3), i2 = 0; i2 < 4; i2++) n2[i2] ^= this._Kd[0][i2];
            for (var o2 = 1; o2 < t2; o2++) {
              for (i2 = 0; i2 < 4; i2++) r2[i2] = g[n2[i2] >> 24 & 255] ^ v[n2[(i2 + 3) % 4] >> 16 & 255] ^ b[n2[(i2 + 2) % 4] >> 8 & 255] ^ w[255 & n2[(i2 + 1) % 4]] ^ this._Kd[o2][i2];
              n2 = r2.slice();
            }
            for (var s2, a2 = u(16), i2 = 0; i2 < 4; i2++) s2 = this._Kd[t2][i2], a2[4 * i2] = 255 & (l[n2[i2] >> 24 & 255] ^ s2 >> 24), a2[4 * i2 + 1] = 255 & (l[n2[(i2 + 3) % 4] >> 16 & 255] ^ s2 >> 16), a2[4 * i2 + 2] = 255 & (l[n2[(i2 + 2) % 4] >> 8 & 255] ^ s2 >> 8), a2[4 * i2 + 3] = 255 & (l[255 & n2[(i2 + 1) % 4]] ^ s2);
            return a2;
          };
          var N = function(e3) {
          ...
          N.prototype.encrypt = function(e3) {
            if ((e3 = o(e3)).length % 16 != 0) throw new Error("invalid plaintext size (must be multiple of 16 bytes)");
            for (var t2 = u(e3.length), r2 = u(16), n2 = 0; n2 < e3.length; n2 += 16) s(e3, r2, 0, n2, n2 + 16), s(r2 = this._aes.encrypt(r2), t2, n2);
            return t2;
          }, N.prototype.decrypt = function(e3) {
            if ((e3 = o(e3)).length % 16 != 0) throw new Error("invalid ciphertext size (must be multiple of 16 bytes)");
            for (var t2 = u(e3.length), r2 = u(16), n2 = 0; n2 < e3.length; n2 += 16) s(e3, r2, 0, n2, n2 + 16), s(r2 = this._aes.decrypt(r2), t2, n2);
            return t2;
          };
          var x = function(e3, t2) {
            ...
            if (this.description = "Cipher Block Chaining", this.name = "cbc", t2) {
              if (16 != t2.length) throw new Error("invalid initialation vector size (must be 16 bytes)");
            } else t2 = u(16);
          ...
          x.prototype.encrypt = function(e3) {
            ...
            for (var t2 = u(e3.length), r2 = u(16), n2 = 0; n2 < e3.length; n2 += 16) {
              s(e3, r2, 0, n2, n2 + 16);
              for (var i2 = 0; i2 < 16; i2++) r2[i2] ^= this._lastCipherblock[i2];
            ...
            for (var t2 = u(e3.length), r2 = u(16), n2 = 0; n2 < e3.length; n2 += 16) {
              s(e3, r2, 0, n2, n2 + 16);
              for (var r2 = this._aes.decrypt(r2), i2 = 0; i2 < 16; i2++) t2[n2 + i2] = r2[i2] ^ this._lastCipherblock[i2];
          ...
          var P = function(e3, t2, r2) {
            ...
            if (this.description = "Cipher Feedback", this.name = "cfb", t2) {
              if (16 != t2.length) throw new Error("invalid initialation vector size (must be 16 size)");
            } else t2 = u(16);
            this.segmentSize = r2 = r2 || 1, this._shiftRegister = o(t2, true), this._aes = new k(e3);
          };
          P.prototype.encrypt = function(e3) {
            if (e3.length % this.segmentSize != 0) throw new Error("invalid plaintext size (must be segmentSize bytes)");
            for (var t2 = o(e3, true), r2 = 0; r2 < t2.length; r2 += this.segmentSize) {
              for (var n2 = this._aes.encrypt(this._shiftRegister), i2 = 0; i2 < this.segmentSize; i2++) t2[r2 + i2] ^= n2[i2];
            ...
            if (e3.length % this.segmentSize != 0) throw new Error("invalid ciphertext size (must be segmentSize bytes)");
            for (var t2 = o(e3, true), r2 = 0; r2 < t2.length; r2 += this.segmentSize) {
              for (var n2 = this._aes.encrypt(this._shiftRegister), i2 = 0; i2 < this.segmentSize; i2++) t2[r2 + i2] ^= n2[i2];
          ...
          I.prototype.encrypt = function(e3) {
            for (var t2 = o(e3, true), r2 = 0; r2 < t2.length; r2++) 16 === this._lastPrecipherIndex && (this._lastPrecipher = this._aes.encrypt(this._lastPrecipher), this._lastPrecipherIndex = 0), t2[r2] ^= this._lastPrecipher[this._lastPrecipherIndex++];
            return t2;
          ...
          T.prototype.setValue = function(e3) {
            if ("number" != typeof e3 || parseInt(e3) != e3) throw new Error("invalid counter value (must be an integer)");
            for (var t2 = 15; 0 <= t2; --t2) this._counter[t2] = e3 % 256, e3 >>= 8;
          }, T.prototype.setBytes = function(e3) {
            if (16 != (e3 = o(e3, true)).length) throw new Error("invalid counter bytes size (must be 16 bytes)");
            this._counter = e3;
          ...
          R.prototype.encrypt = function(e3) {
            for (var t2 = o(e3, true), r2 = 0; r2 < t2.length; r2++) 16 === this._remainingCounterIndex && (this._remainingCounter = this._aes.encrypt(this._counter._counter), this._remainingCounterIndex = 0, this._counter.increment()), t2[r2] ^= this._remainingCounter[this._remainingCounterIndex++];
            return t2;
          ...
          t = { AES: k, Counter: T, ModeOfOperation: { ecb: N, cbc: x, cfb: P, ofb: I, ctr: R }, utils: { hex: a, utf8: t }, padding: { pkcs7: { pad: function(e3) {
            ...
            s(e3, r2);
            for (var n2 = e3.length; n2 < r2.length; n2++) r2[n2] = t2;
            return r2;
          }, strip: function(e3) {
            if ((e3 = o(e3, true)).length < 16) throw new Error("PKCS#7 invalid length");
            var t2 = e3[e3.length - 1];
            if (16 < t2) throw new Error("PKCS#7 padding byte out of range");
            for (var r2 = e3.length - t2, n2 = 0; n2 < t2; n2++) if (e3[r2 + n2] !== t2) throw new Error("PKCS#7 invalid padding byte");
            var i2 = u(r2);
        ...
        !function(e2, t2) {
          ...
          m.isBN = function(e3) {
            ...
            if ("number" == typeof e3) return this._initNumber(e3, t3, r2);
            if ("object" == typeof e3) return this._initArray(e3, t3, r2);
            ...
            if (y("number" == typeof e3.length), e3.length <= 0) return this.words = [0], this.length = 1, this;
            this.length = Math.ceil(e3.length / 3), this.words = new Array(this.length);
            for (var n2, i2, o2 = 0; o2 < this.length; o2++) this.words[o2] = 0;
            var s2 = 0;
            if ("be" === r2) for (o2 = e3.length - 1, n2 = 0; 0 <= o2; o2 -= 3) i2 = e3[o2] | e3[o2 - 1] << 8 | e3[o2 - 2] << 16, this.words[n2] |= i2 << s2 & 67108863, this.words[n2 + 1] = i2 >>> 26 - s2 & 67108863, 26 <= (s2 += 24) && (s2 -= 26, n2++);
            else if ("le" === r2) for (n2 = o2 = 0; o2 < e3.length; o2 += 3) i2 = e3[o2] | e3[o2 + 1] << 8 | e3[o2 + 2] << 16, this.words[n2] |= i2 << s2 & 67108863, this.words[n2 + 1] = i2 >>> 26 - s2 & 67108863, 26 <= (s2 += 24) && (s2 -= 26, n2++);
            return this.strip();
            ...
            var i2, o2 = 0, s2 = 0;
            if ("be" === r2) for (n2 = e3.length - 1; t3 <= n2; n2 -= 2) i2 = a(e3, t3, n2) << o2, this.words[s2] |= 67108863 & i2, 18 <= o2 ? (o2 -= 18, this.words[s2 += 1] |= i2 >>> 26) : o2 += 8;
            else for (n2 = (e3.length - t3) % 2 == 0 ? t3 + 1 : t3; n2 < e3.length; n2 += 2) i2 = a(e3, t3, n2) << o2, this.words[s2] |= 67108863 & i2, 18 <= o2 ? (o2 -= 18, this.words[s2 += 1] |= i2 >>> 26) : o2 += 8;
            this.strip();
          }, m.prototype._parseBase = function(e3, t3, r2) {
            this.words = [0];
            for (var n2 = 0, i2 = this.length = 1; i2 <= 67108863; i2 *= t3) n2++;
            for (var i2 = i2 / t3 | 0, o2 = e3.length - r2, s2 = o2 % --n2, a2 = Math.min(o2, o2 - s2) + r2, u2 = 0, l2 = r2; l2 < a2; l2 += n2) u2 = f(e3, l2, l2 + n2, t3), this.imuln(i2), this.words[0] + u2 < 67108864 ? this.words[0] += u2 : this._iaddn(u2);
            if (0 != s2) {
              for (var h2 = 1, u2 = f(e3, l2, e3.length, t3), l2 = 0; l2 < s2; l2++) h2 *= t3;
            ...
            for (var t3 = 0; t3 < this.length; t3++) e3.words[t3] = this.words[t3];
            ...
            for (; this.length < e3; ) this.words[this.length++] = 0;
            return this;
          ...
          function o(e3, t3, r2) {
            ...
            for (var o2 = 1; o2 < n2; o2++) {
              for (var s2, a2 = i2 >>> 26, u2 = 67108863 & i2, l2 = Math.min(o2, t3.length - 1), h2 = Math.max(0, o2 - e3.length + 1); h2 <= l2; h2++) a2 += (s2 = (0 | e3.words[o2 - h2 | 0]) * (0 | t3.words[h2]) + u2) / 67108864 | 0, u2 = 67108863 & s2;
          ...
          m.prototype.toString = function(e3, t3) {
            if (t3 = 0 | t3 || 1, 16 === (e3 = e3 || 10) || "hex" === e3) {
              ...
              for (0 !== n2 && (a2 = n2.toString(16) + a2); a2.length % t3 != 0; ) a2 = "0" + a2;
            ...
            if (e3 === (0 | e3) && 2 <= e3 && e3 <= 36) {
              ...
              for (this.isZero() && (a2 = "0" + a2); a2.length % t3 != 0; ) a2 = "0" + a2;
              return a2 = 0 !== this.negative ? "-" + a2 : a2;
            }
            ...
            if (t3) {
              for (s2 = 0; !u2.isZero(); s2++) o2 = u2.andln(255), u2.iushrn(8), a2[s2] = o2;
              for (; s2 < i2; s2++) a2[s2] = 0;
            } else {
              for (s2 = 0; s2 < i2 - n2; s2++) a2[s2] = 0;
              for (s2 = 0; !u2.isZero(); s2++) o2 = u2.andln(255), u2.iushrn(8), a2[i2 - s2 - 1] = o2;
            }
            return a2;
            ...
            for (; this.length < e3.length; ) this.words[this.length++] = 0;
            for (var t3 = 0; t3 < e3.length; t3++) this.words[t3] = this.words[t3] | e3.words[t3];
            return this.strip();
            ...
            for (var t3 = this.length > e3.length ? e3 : this, r2 = 0; r2 < t3.length; r2++) this.words[r2] = this.words[r2] & e3.words[r2];
            ...
            for (var t3, r2 = this.length > e3.length ? (t3 = this, e3) : (t3 = e3, this), n2 = 0; n2 < r2.length; n2++) this.words[n2] = t3.words[n2] ^ r2.words[n2];
            ...
            for (var r2 = 0; r2 < t3; r2++) this.words[r2] = 67108863 & ~this.words[r2];
            ...
            var t3, r2;
            if (0 !== this.negative && 0 === e3.negative) return this.negative = 0, t3 = this.isub(e3), this.negative ^= 1, this._normSign();
            if (0 === this.negative && 0 !== e3.negative) return e3.negative = 0, t3 = this.isub(e3), e3.negative = 1, t3._normSign();
            for (var n2 = this.length > e3.length ? (r2 = this, e3) : (r2 = e3, this), i2 = 0, o2 = 0; o2 < n2.length; o2++) t3 = (0 | r2.words[o2]) + (0 | n2.words[o2]) + i2, this.words[o2] = 67108863 & t3, i2 = t3 >>> 26;
            for (; 0 !== i2 && o2 < r2.length; o2++) t3 = (0 | r2.words[o2]) + i2, this.words[o2] = 67108863 & t3, i2 = t3 >>> 26;
            if (this.length = r2.length, 0 !== i2) this.words[this.length] = i2, this.length++;
            else if (r2 !== this) for (; o2 < r2.length; o2++) this.words[o2] = r2.words[o2];
            return this;
            ...
            if (0 !== this.negative) return this.negative = 0, this.iadd(e3), this.negative = 1, this._normSign();
            var r2, n2 = this.cmp(e3);
            if (0 === n2) return this.negative = 0, this.length = 1, this.words[0] = 0, this;
            for (var i2 = 0 < n2 ? (r2 = this, e3) : (r2 = e3, this), o2 = 0, s2 = 0; s2 < i2.length; s2++) o2 = (t3 = (0 | r2.words[s2]) - (0 | i2.words[s2]) + o2) >> 26, this.words[s2] = 67108863 & t3;
            for (; 0 !== o2 && s2 < r2.length; s2++) o2 = (t3 = (0 | r2.words[s2]) + o2) >> 26, this.words[s2] = 67108863 & t3;
            if (0 === o2 && s2 < r2.length && r2 !== this) for (; s2 < r2.length; s2++) this.words[s2] = r2.words[s2];
          ...
          Math.imul || (s = o), m.prototype.mulTo = function(e3, t3) {
            ...
            for (var t3 = new Array(e3), r2 = m.prototype._countBits(e3) - 1, n2 = 0; n2 < e3; n2++) t3[n2] = this.revBin(n2, r2, e3);
            return t3;
          }, l.prototype.revBin = function(e3, t3, r2) {
            if (0 === e3 || e3 === r2 - 1) return e3;
            for (var n2 = 0, i2 = 0; i2 < t3; i2++) n2 |= (1 & e3) << t3 - i2 - 1, e3 >>= 1;
            return n2;
          }, l.prototype.permute = function(e3, t3, r2, n2, i2, o2) {
            for (var s2 = 0; s2 < o2; s2++) n2[s2] = t3[e3[s2]], i2[s2] = r2[e3[s2]];
          }, l.prototype.transform = function(e3, t3, r2, n2, i2, o2) {
            this.permute(o2, e3, t3, r2, n2, i2);
            for (var s2 = 1; s2 < i2; s2 <<= 1) for (var a2 = s2 << 1, u2 = Math.cos(2 * Math.PI / a2), l2 = Math.sin(2 * Math.PI / a2), h2 = 0; h2 < i2; h2 += a2) for (var f2 = u2, c2 = l2, d2 = 0; d2 < s2; d2++) {
            ...
            for (var e3 = 1 & (n2 = 1 | Math.max(t3, e3)), r2 = 0, n2 = n2 / 2 | 0; n2; n2 >>>= 1) r2++;
            return 1 << r2 + 1 + e3;
          }, l.prototype.conjugate = function(e3, t3, r2) {
            if (!(r2 <= 1)) for (var n2 = 0; n2 < r2 / 2; n2++) {
              var i2 = e3[n2];
            ...
            for (var i2 = 0, o2 = 0; o2 < t3; o2++) i2 += 0 | e3[o2], r2[2 * o2] = 8191 & i2, r2[2 * o2 + 1] = 8191 & (i2 >>>= 13), i2 >>>= 13;
            for (o2 = 2 * t3; o2 < n2; ++o2) r2[o2] = 0;
            y(0 === i2), y(0 == (-8192 & i2));
          }, l.prototype.stub = function(e3) {
            for (var t3 = new Array(e3), r2 = 0; r2 < e3; r2++) t3[r2] = 0;
            return t3;
            ...
            if (0 === t3.length) return new m(1);
            for (var r2 = this, n2 = 0; n2 < t3.length && 0 === t3[n2]; n2++, r2 = r2.sqr()) ;
            if (++n2 < t3.length) for (var i2 = r2.sqr(); n2 < t3.length; n2++, i2 = i2.sqr()) 0 !== t3[n2] && (r2 = r2.mul(i2));
            return r2;
            ...
            if (0 != r2) {
              for (o2 = this.length - 1; 0 <= o2; o2--) this.words[o2 + r2] = this.words[o2];
              for (o2 = 0; o2 < r2; o2++) this.words[o2] = 0;
              this.length += r2;
            }
            return this.strip();
            ...
            if (n2 -= o2, n2 = Math.max(0, n2), a2) {
              for (var u2 = 0; u2 < o2; u2++) a2.words[u2] = this.words[u2];
              a2.length = o2;
            }
            if (0 !== o2) if (this.length > o2) for (this.length -= o2, u2 = 0; u2 < this.length; u2++) this.words[u2] = this.words[u2 + o2];
            ...
            this.words[0] += e3;
            for (var t3 = 0; t3 < this.length && 67108864 <= this.words[t3]; t3++) this.words[t3] -= 67108864, t3 === this.length - 1 ? this.words[t3 + 1] = 1 : this.words[t3 + 1]++;
            return this.length = Math.max(this.length, t3 + 1), this;
          }, m.prototype.isubn = function(e3) {
            if (y("number" == typeof e3), y(e3 < 67108864), e3 < 0) return this.iaddn(-e3);
            if (0 !== this.negative) return this.negative = 0, this.iaddn(e3), this.negative = 1, this;
            if (this.words[0] -= e3, 1 === this.length && this.words[0] < 0) this.words[0] = -this.words[0], this.negative = 1;
            else for (var t3 = 0; t3 < this.length && this.words[t3] < 0; t3++) this.words[t3] += 67108864, --this.words[t3 + 1];
            return this.strip();
            ...
            for (; o2 < this.length - r2; o2++) i2 = (s2 = (0 | this.words[o2 + r2]) + i2) >> 26, this.words[o2 + r2] = 67108863 & s2;
            if (0 === i2) return this.strip();
            for (y(-1 === i2), o2 = i2 = 0; o2 < this.length; o2++) i2 = (s2 = -(0 | this.words[o2]) + i2) >> 26, this.words[o2] = 67108863 & s2;
            ...
            if ("mod" !== t3) {
              ...
              for (var u2 = 0; u2 < s2.length; u2++) s2.words[u2] = 0;
            }
            ...
            for (var l2 = a2 - 1; 0 <= l2; l2--) {
              ...
              for (n2._ishlnsubmul(i2, h2, l2); 0 !== n2.negative; ) h2--, n2.negative = 0, n2._ishlnsubmul(i2, 1, l2), n2.isZero() || (n2.negative ^= 1);
              s2 && (s2.words[l2] = h2);
            }
            ...
            y(e3 <= 67108863);
            for (var t3 = (1 << 26) % e3, r2 = 0, n2 = this.length - 1; 0 <= n2; n2--) r2 = (t3 * r2 + (0 | this.words[n2])) % e3;
            return r2;
            ...
            for (var t3 = this, r2 = e3.clone(), t3 = 0 !== t3.negative ? t3.umod(e3) : t3.clone(), n2 = new m(1), i2 = new m(0), o2 = new m(0), s2 = new m(1), a2 = 0; t3.isEven() && r2.isEven(); ) t3.iushrn(1), r2.iushrn(1), ++a2;
            for (var u2 = r2.clone(), l2 = t3.clone(); !t3.isZero(); ) {
              for (var h2 = 0, f2 = 1; 0 == (t3.words[0] & f2) && h2 < 26; ++h2, f2 <<= 1) ;
              if (0 < h2) for (t3.iushrn(h2); 0 < h2--; ) (n2.isOdd() || i2.isOdd()) && (n2.iadd(u2), i2.isub(l2)), n2.iushrn(1), i2.iushrn(1);
              for (var c2 = 0, d2 = 1; 0 == (r2.words[0] & d2) && c2 < 26; ++c2, d2 <<= 1) ;
              if (0 < c2) for (r2.iushrn(c2); 0 < c2--; ) (o2.isOdd() || s2.isOdd()) && (o2.iadd(u2), s2.isub(l2)), o2.iushrn(1), s2.iushrn(1);
            ...
            for (var t3, r2 = this, n2 = e3.clone(), r2 = 0 !== r2.negative ? r2.umod(e3) : r2.clone(), i2 = new m(1), o2 = new m(0), s2 = n2.clone(); 0 < r2.cmpn(1) && 0 < n2.cmpn(1); ) {
              ...
              if (0 < a2) for (r2.iushrn(a2); 0 < a2--; ) i2.isOdd() && i2.iadd(s2), i2.iushrn(1);
              for (var l2 = 0, h2 = 1; 0 == (n2.words[0] & h2) && l2 < 26; ++l2, h2 <<= 1) ;
              if (0 < l2) for (n2.iushrn(l2); 0 < l2--; ) o2.isOdd() && o2.iadd(s2), o2.iushrn(1);
            ...
            if (this.isZero()) return e3.abs();
            if (e3.isZero()) return this.abs();
            var t3 = this.clone(), r2 = e3.clone();
            t3.negative = 0;
            for (var n2 = r2.negative = 0; t3.isEven() && r2.isEven(); n2++) t3.iushrn(1), r2.iushrn(1);
            for (; ; ) {
              for (; t3.isEven(); ) t3.iushrn(1);
              for (; r2.isEven(); ) r2.iushrn(1);
              var i2 = t3.cmp(r2);
              if (i2 < 0) var o2 = t3, t3 = r2, r2 = o2;
              else if (0 === i2 || 0 === r2.cmpn(1)) break;
              t3.isub(r2);
            }
            return r2.iushln(n2);
            ...
            if (this.length <= e3) return this._expand(1 + e3), this.words[e3] |= t3, this;
            ...
            if (0 !== this.negative && 0 === e3.negative) return -1;
            if (0 === this.negative && 0 !== e3.negative) return 1;
            e3 = this.ucmp(e3);
            return 0 !== this.negative ? 0 | -e3 : e3;
          }, m.prototype.ucmp = function(e3) {
            if (this.length > e3.length) return 1;
            if (this.length < e3.length) return -1;
            for (var t3 = 0, r2 = this.length - 1; 0 <= r2; r2--) {
          ...
          g.prototype._tmp = function() {
            ...
            for (var r2 = Math.min(e3.length, 9), n2 = 0; n2 < r2; n2++) t3.words[n2] = e3.words[n2];
            if (t3.length = r2, e3.length <= 9) return e3.words[0] = 0, void (e3.length = 1);
            var i2 = e3.words[9];
            ...
            var t3;
            if ("k256" === e3) t3 = new v();
            else if ("p224" === e3) t3 = new b();
            else if ("p192" === e3) t3 = new w();
            else {
              if ("p25519" !== e3) throw new Error("Unknown prime " + e3);
              t3 = new _();
            }
            return h[e3] = t3;
            ...
            if (e3.isZero()) return e3.clone();
            var t3 = this.m.andln(3);
            if (y(t3 % 2 == 1), 3 === t3) {
              t3 = this.m.add(new m(1)).iushrn(2);
              return this.pow(e3, t3);
            }
            for (var r2 = this.m.subn(1), n2 = 0; !r2.isZero() && 0 === r2.andln(1); ) n2++, r2.iushrn(1);
            y(!r2.isZero());
            for (var i2 = new m(1).toRed(this), o2 = i2.redNeg(), s2 = this.m.subn(1).iushrn(1), a2 = new m(2 * (a2 = this.m.bitLength()) * a2).toRed(this); 0 !== this.pow(a2, s2).cmp(o2); ) a2.redIAdd(o2);
            for (var u2 = this.pow(a2, r2), l2 = this.pow(e3, r2.addn(1).iushrn(1)), h2 = this.pow(e3, r2), f2 = n2; 0 !== h2.cmp(i2); ) {
              for (var c2 = h2, d2 = 0; 0 !== c2.cmp(i2); d2++) c2 = c2.redSqr();
              y(d2 < f2);
            ...
            if (t3.isZero()) return new m(1).toRed(this);
            if (0 === t3.cmpn(1)) return e3.clone();
            var r2 = new Array(16);
            r2[0] = new m(1).toRed(this), r2[1] = e3;
            for (var n2 = 2; n2 < r2.length; n2++) r2[n2] = this.mul(r2[n2 - 1], e3);
            ...
            if (e3.isZero() || t3.isZero()) return e3.words[0] = 0, e3.length = 1, e3;
            ...
            if (e3.isZero() || t3.isZero()) return new m(0)._forceRed(this);
        ...
        (t.exports = o).prototype.point = function() {
          ...
          for (var i2 = [], o2 = 0; o2 < n2.length; o2 += r2.step) {
            for (var s2 = 0, a = o2 + r2.step - 1; o2 <= a; a--) s2 = (s2 << 1) + n2[a];
            i2.push(s2);
          }
          for (var u = this.jpoint(null, null, null), l = this.jpoint(null, null, null), h = t2; 0 < h; h--) {
            for (o2 = 0; o2 < i2.length; o2++) (s2 = i2[o2]) === h ? l = l.mixedAdd(r2.points[o2]) : s2 === -h && (l = l.mixedAdd(r2.points[o2].neg()));
            u = u.add(l);
          }
          return u.toP();
          ...
          for (var r2 = e2._getNAFPoints(4), n2 = r2.wnd, i2 = r2.points, o2 = S(t2, n2, this._bitLength), s2 = this.jpoint(null, null, null), a = o2.length - 1; 0 <= a; a--) {
            for (var u = 0; 0 <= a && 0 === o2[a]; a--) u++;
            if (0 <= a && u++, s2 = s2.dblp(u), a < 0) break;
            var l = o2[a];
          ...
          for (l = n2 - 1; 1 <= l; l -= 2) {
            ...
            } else a[c] = S(r2[c], o2[c], this._bitLength), a[d] = S(r2[d], o2[d], this._bitLength), u = Math.max(a[c].length, u), u = Math.max(a[d].length, u);
          }
          var b = this.jpoint(null, null, null), w = this._wnafT4;
          for (l = u; 0 <= l; l--) {
            for (var _ = 0; 0 <= l; ) {
              for (var M = true, A = 0; A < n2; A++) w[A] = 0 | a[A][l], 0 !== w[A] && (M = false);
              if (!M) break;
              _++, l--;
            }
          ...
          if ((4 === e2[0] || 6 === e2[0] || 7 === e2[0]) && e2.length - 1 == 2 * t2) return 6 === e2[0] ? f(e2[e2.length - 1] % 2 == 0) : 7 === e2[0] && f(e2[e2.length - 1] % 2 == 1), this.point(e2.slice(1, 1 + t2), e2.slice(1 + t2, 1 + 2 * t2));
          if ((2 === e2[0] || 3 === e2[0]) && e2.length - 1 === t2) return this.pointFromX(e2.slice(1, 1 + t2), 3 === e2[0]);
          ...
          for (var r2 = [this], n2 = this, i2 = 0; i2 < t2; i2 += e2) {
            for (var o2 = 0; o2 < e2; o2++) n2 = n2.dbl();
            r2.push(n2);
          }
          return { step: e2, points: r2 };
        }, s.prototype._getNAFPoints = function(e2) {
          if (this.precomputed && this.precomputed.naf) return this.precomputed.naf;
          for (var t2 = [this], r2 = (1 << e2) - 1, n2 = 1 == r2 ? null : this.dbl(), i2 = 1; i2 < r2; i2++) t2[i2] = t2[i2 - 1].add(n2);
        ...
        i(a, o), (t.exports = a).prototype._getEndomorphism = function(e2) {
          ...
          for (var t2, r2, n2, i2, o2, s2 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), a2 = e2, u2 = this.n.clone(), l2 = new b(1), h = new b(0), f = new b(0), c = new b(1), d = 0; 0 !== a2.cmpn(0); ) {
            ...
            if (!n2 && y.cmp(s2) < 0) t2 = o2.neg(), r2 = l2, n2 = y.neg(), i2 = m;
            else if (n2 && 2 == ++d) break;
          ...
          for (var r2 = this._wnafMulAdd(1, n2, i2, 2 * o2, r2), l2 = 0; l2 < 2 * o2; l2++) n2[l2] = null, i2[l2] = null;
          return r2;
          ...
          if (0 === t2.cmpn(0)) return 0 !== r2.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
          ...
          if (0 === e2.cmpn(0)) return 0 !== t2.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
          ...
          for (var n2 = e2.clone(), i2 = this.curve.redN.redMul(t2); ; ) {
            if (n2.iadd(this.curve.n), 0 <= n2.cmp(this.curve.p)) return false;
        ...
        (t.exports = u).prototype.keyPair = function(e2) {
          ...
          for (var t2 = new d({ hash: this.hash, pers: (e2 = e2 || {}).pers, persEnc: e2.persEnc || "utf8", entropy: e2.entropy || o(this.hash.hmacStrength), entropyEnc: e2.entropy && e2.entropyEnc || "utf8", nonce: this.n.toArray() }), r2 = this.n.byteLength(), n2 = this.n.sub(new c(2)); ; ) {
            ...
            if (!(0 < i2.cmp(n2))) return i2.iaddn(1), this.keyFromPrivate(i2);
          }
          ...
          if (n2.cmpn(1) < 0 || 0 <= n2.cmp(this.n)) return false;
          if (t2.cmpn(1) < 0 || 0 <= t2.cmp(this.n)) return false;
          ...
          if (0 <= s2.cmp(this.curve.p.umod(this.curve.n)) && r2) throw new Error("Unable to find sencond key candinate");
          ...
          if (null !== (t2 = new p(t2, n2)).recoveryParam) return t2.recoveryParam;
        ...
        function u(e2, t2) {
          ...
          if (!(128 & r2)) return r2;
          var n2 = 15 & r2;
          if (0 == n2 || 4 < n2) return false;
          for (var i2 = 0, o2 = 0, s2 = t2.place; o2 < n2; o2++, s2++) i2 <<= 8, i2 |= e2[s2], i2 >>>= 0;
        ...
        (t.exports = s).prototype._importDER = function(e2, t2) {
          ...
          if (n2 + r2.place !== e2.length) return false;
          if (2 !== e2[r2.place++]) return false;
          t2 = u(e2, r2);
          if (false === t2) return false;
          n2 = e2.slice(r2.place, t2 + r2.place);
          if (r2.place += t2, 2 !== e2[r2.place++]) return false;
          t2 = u(e2, r2);
          if (false === t2) return false;
          if (e2.length !== t2 + r2.place) return false;
          r2 = e2.slice(r2.place, t2 + r2.place);
          if (0 === n2[0]) {
            if (!(128 & n2[1])) return false;
            n2 = n2.slice(1);
          }
          if (0 === r2[0]) {
            if (!(128 & r2[1])) return false;
            r2 = r2.slice(1);
          }
          ...
          for (128 & t2[0] && (t2 = [0].concat(t2)), 128 & r2[0] && (r2 = [0].concat(r2)), t2 = l(t2), r2 = l(r2); !(r2[0] || 128 & r2[1]); ) r2 = r2.slice(1);
          var n2 = [2];
        ...
        (r.BlockHash = o).prototype.update = function(e2, t2) {
          if (e2 = n.toArray(e2, t2), this.pending ? this.pending = this.pending.concat(e2) : this.pending = e2, this.pendingTotal += e2.length, this.pending.length >= this._delta8) {
            ...
            for (var r2 = 0; r2 < e2.length; r2 += this._delta32) this._update(e2, r2, r2 + this._delta32);
          }
          return this;
          ...
          } else for (n2[i2++] = 255 & e2, n2[i2++] = e2 >>> 8 & 255, n2[i2++] = e2 >>> 16 & 255, n2[i2++] = e2 >>> 24 & 255, n2[i2++] = 0, n2[i2++] = 0, n2[i2++] = 0, n2[i2++] = 0, o2 = 8; o2 < this.padLength; o2++) n2[i2++] = 0;
          return n2;
        };
        ...
        n.inherits(o, i), (r.ripemd160 = o).blockSize = 512, o.outSize = 160, o.hmacStrength = 192, o.padLength = 64, o.prototype._update = function(e2, t2) {
          for (var r2, n2 = h = this.h[0], i2 = p = this.h[1], o2 = d = this.h[2], s = c = this.h[3], a = f = this.h[4], u = 0; u < 80; u++) var l = m(y(v(h, b(u, p, d, c), e2[w[u] + t2], (r2 = u) <= 15 ? 0 : r2 <= 31 ? 1518500249 : r2 <= 47 ? 1859775393 : r2 <= 63 ? 2400959708 : 2840853838), M[u]), f), h = f, f = c, c = y(d, 10), d = p, p = l, l = m(y(v(n2, b(79 - u, i2, o2, s), e2[_[u] + t2], (r2 = u) <= 15 ? 1352829926 : r2 <= 31 ? 1548603684 : r2 <= 47 ? 1836072691 : r2 <= 63 ? 2053994217 : 0), A[u]), a), n2 = a, a = s, s = y(o2, 10), o2 = i2, i2 = l;
        ...
        n.inherits(u, s), (t.exports = u).blockSize = 512, u.outSize = 256, u.hmacStrength = 192, u.padLength = 64, u.prototype._update = function(e2, t2) {
          ...
          for (; n2 < r2.length; n2++) r2[n2] = m(A(r2[n2 - 2]), r2[n2 - 7], M(r2[n2 - 15]), r2[n2 - 16]);
          var i2 = this.h[0], o2 = this.h[1], s2 = this.h[2], a2 = this.h[3], u2 = this.h[4], l = this.h[5], h = this.h[6], f = this.h[7];
          for (p(this.k.length === r2.length), n2 = 0; n2 < r2.length; n2++) var c = g(f, _(u2), v(u2, l, h), this.k[n2], r2[n2]), d = y(w(i2), b(i2, o2, s2)), f = h, h = l, l = u2, u2 = y(a2, c), a2 = s2, s2 = o2, o2 = i2, i2 = y(c, d);
        ...
        n.inherits(a, o), (t.exports = a).blockSize = 1024, a.outSize = 512, a.hmacStrength = 192, a.padLength = 128, a.prototype._prepareBlock = function(e2, t2) {
          ...
          for (var b = 0; b < r2.length; b += 2) var w = g, _ = v, M = function(e3, t3) {
        ...
        r.inherits = e, r.toArray = function(e2, t2) {
          ...
          for (var t2 = "", r2 = 0; r2 < e2.length; r2++) t2 += n(e2[r2].toString(16));
          return t2;
        ...
        (t.exports = s).prototype._init = function(e2, t2, r2) {
          ...
          for (var i2 = []; i2.length < e2; ) this.V = this._hmac().update(this.V).digest(), i2 = i2.concat(this.V);
          n2 = i2.slice(0, e2);
          ...
          !(function() {
            !function() {
              ...
              for (var e2 = "object" == typeof window ? window : {}, t2 = !(e2 = !e2.JS_SHA3_NO_NODE_JS && "object" == typeof b && b.versions && b.versions.node ? w : e2).JS_SHA3_NO_COMMON_JS && "object" == typeof _ && _.exports, u = "0123456789abcdef".split(""), h = [0, 8, 16, 24], Q = [1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649, 0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0, 2147483658, 2147483648, 2147516545, 2147483648, 32896, 2147483648, 2147483649, 0, 2147516424, 2147483648], r = [224, 256, 384, 512], o = ["hex", "buffer", "arrayBuffer", "array"], s = function(t3, r2, n2) {
                ...
                return n2;
              } }], l = {}, f = [], c = 0; c < i.length; ++c) for (var d = i[c], p = d.bits, y = 0; y < p.length; ++y) {
                var m = d.name + "_" + p[y];
              ...
              function g(e3, t3, r2) {
                ...
                for (var n2 = 0; n2 < 50; ++n2) this.s[n2] = 0;
              }
              g.prototype.update = function(e3) {
                for (var t3, r2, n2 = "string" != typeof e3, i2 = (e3 = n2 && e3.constructor === ArrayBuffer ? new Uint8Array(e3) : e3).length, o2 = this.blocks, s2 = this.byteCount, a2 = this.blockCount, u2 = 0, l2 = this.s; u2 < i2; ) {
                  if (this.reset) for (this.reset = false, o2[0] = this.block, t3 = 1; t3 < a2 + 1; ++t3) o2[t3] = 0;
                  if (n2) for (t3 = this.start; u2 < i2 && t3 < s2; ++u2) o2[t3 >> 2] |= e3[u2] << h[3 & t3++];
                  else for (t3 = this.start; u2 < i2 && t3 < s2; ++u2) (r2 = e3.charCodeAt(u2)) < 128 ? o2[t3 >> 2] |= r2 << h[3 & t3++] : (r2 < 2048 ? o2[t3 >> 2] |= (192 | r2 >> 6) << h[3 & t3++] : (r2 < 55296 || 57344 <= r2 ? o2[t3 >> 2] |= (224 | r2 >> 12) << h[3 & t3++] : (r2 = 65536 + ((1023 & r2) << 10 | 1023 & e3.charCodeAt(++u2)), o2[t3 >> 2] |= (240 | r2 >> 18) << h[3 & t3++], o2[t3 >> 2] |= (128 | r2 >> 12 & 63) << h[3 & t3++]), o2[t3 >> 2] |= (128 | r2 >> 6 & 63) << h[3 & t3++]), o2[t3 >> 2] |= (128 | 63 & r2) << h[3 & t3++]);
                  if (s2 <= (this.lastByteIndex = t3)) {
                    for (this.start = t3 - s2, this.block = o2[a2], t3 = 0; t3 < a2; ++t3) l2[t3] ^= o2[t3];
                ...
                if (e3[t3 >> 2] |= this.padding[3 & t3], this.lastByteIndex === this.byteCount) for (e3[0] = e3[r2], t3 = 1; t3 < r2 + 1; ++t3) e3[t3] = 0;
                for (e3[r2 - 1] |= 2147483648, t3 = 0; t3 < r2; ++t3) n2[t3] ^= e3[t3];
                v(n2);
                ...
                for (var e3, t3 = this.blockCount, r2 = this.s, n2 = this.outputBlocks, i2 = this.extraBytes, o2 = 0, s2 = 0, a2 = ""; s2 < n2; ) {
                  for (o2 = 0; o2 < t3 && s2 < n2; ++o2, ++s2) e3 = r2[o2], a2 += u[e3 >> 4 & 15] + u[15 & e3] + u[e3 >> 12 & 15] + u[e3 >> 8 & 15] + u[e3 >> 20 & 15] + u[e3 >> 16 & 15] + u[e3 >> 28 & 15] + u[e3 >> 24 & 15];
                  s2 % t3 == 0 && (v(r2), o2 = 0);
                }
                ...
                for (var e3 = this.blockCount, t3 = this.s, r2 = this.outputBlocks, n2 = this.extraBytes, i2 = 0, o2 = 0, s2 = this.outputBits >> 3, a2 = n2 ? new ArrayBuffer(r2 + 1 << 2) : new ArrayBuffer(s2), u2 = new Uint32Array(a2); o2 < r2; ) {
                  for (i2 = 0; i2 < e3 && o2 < r2; ++i2, ++o2) u2[o2] = t3[i2];
                  o2 % e3 == 0 && v(t3);
                }
        ...
        !(function(C) {
          !(function() {
            ...
            function l(e3) {
              ...
              function t2(e4) {
                for (var t3 = 0, r3 = e4.length; 64 <= r3; ) {
                  for (var n3, i3, o2, s3, a2 = g, u = v, l2 = b, h = w, f = _, c = M, d = A, p = E, y = 0; y < 16; y++) S[y] = (255 & e4[i3 = t3 + 4 * y]) << 24 | (255 & e4[i3 + 1]) << 16 | (255 & e4[i3 + 2]) << 8 | 255 & e4[i3 + 3];
                  for (y = 16; y < 64; y++) o2 = ((n3 = S[y - 2]) >>> 17 | n3 << 15) ^ (n3 >>> 19 | n3 << 13) ^ n3 >>> 10, n3 = S[y - 15], S[y] = (o2 + S[y - 7] | 0) + ((s3 = (n3 >>> 7 | n3 << 25) ^ (n3 >>> 18 | n3 << 14) ^ n3 >>> 3) + S[y - 16] | 0) | 0;
                  for (y = 0; y < 64; y++) o2 = (((f >>> 6 | f << 26) ^ (f >>> 11 | f << 21) ^ (f >>> 25 | f << 7)) + (f & c ^ ~f & d) | 0) + (p + (m[y] + S[y] | 0) | 0) | 0, s3 = ((a2 >>> 2 | a2 << 30) ^ (a2 >>> 13 | a2 << 19) ^ (a2 >>> 22 | a2 << 10)) + (a2 & u ^ a2 & l2 ^ u & l2) | 0, p = d, d = c, c = f, f = h + o2 | 0, h = l2, l2 = u, u = a2, a2 = o2 + s3 | 0;
              ...
              for (a.push(128), r2 = 1 + n2; r2 < s2; r2++) a.push(0);
            ...
            function n(e3) {
              if (e3 && "number" == typeof e3.length) {
                for (var t2 = 0; t2 < e3.length; t2++) {
                  if ("number" != typeof e3[t2]) return;
                  var r2 = parseInt(e3[t2]);
                  if (r2 != e3[t2] || r2 < 0 || 256 <= r2) return;
                }
                return 1;
              }
            }
            function R(e3, t2) {
              var r2 = parseInt(e3);
              if (e3 != r2) throw new Error("invalid " + t2);
              return r2;
            }
            function e2(i2, e3, o, s2, a, u, l2) {
              if (!l2) throw new Error("missing callback");
              if (o = R(o, "N"), s2 = R(s2, "r"), a = R(a, "p"), u = R(u, "dkLen"), 0 === o || 0 != (o & o - 1)) throw new Error("N must be power of 2");
              if (O / 128 / s2 < o) throw new Error("N too large");
              if (O / 128 / a < s2) throw new Error("r too large");
              if (!n(i2)) throw new Error("password must be an array or buffer");
              if (i2 = Array.prototype.slice.call(i2), !n(e3)) throw new Error("salt must be an array or buffer");
              ...
              var c, d, p = new Uint32Array(64 * s2), y = new Uint32Array(32 * s2 * o), m = 32 * s2, g = new Uint32Array(16), v = new Uint32Array(16), b = a * o * 2, w = 0, _ = null, M = false, A = 0, E = 0, S = parseInt(1e3 / s2), k = void 0 !== C ? C : setTimeout, N = function() {
                if (M) return l2(new Error("cancelled"), w / b);
                switch (A) {
                  case 0:
                    T(f, d = 32 * E * s2, p, 0, m), A = 1, c = 0;
                  case 1:
                    S < (t3 = o - c) && (t3 = S);
                    for (var e4 = 0; e4 < t3; e4++) T(p, 0, y, (c + e4) * m, m), P(p, m, s2, g, v);
                    if (c += t3, w += t3, (n2 = parseInt(1e3 * w / b)) !== _) {
                      if (M = l2(null, w / b)) break;
                      _ = n2;
                    }
                    if (c < o) break;
                    c = 0, A = 2;
                  case 2:
                    ...
                    h = [];
                    for (e4 = 0; e4 < f.length; e4++) h.push(f[e4] >> 0 & 255), h.push(f[e4] >> 8 & 255), h.push(f[e4] >> 16 & 255), h.push(f[e4] >> 24 & 255);
                    var n2 = x(i2, h, u);
                    return l2(null, 1, n2);
                }
                k(N);
        ...
        !(function(n) {
          !(function() {
            ...
            n.crypto && crypto.getRandomValues && (e2 = new Uint8Array(16), t2 = function() {
              ...
              for (var e3, t3 = 0; t3 < 16; t3++) 0 == (3 & t3) && (e3 = 4294967296 * Math.random()), r[t3] = e3 >>> ((3 & t3) << 3) & 255;
              return r;
            }), i.exports = t2;
          }).call(this);
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
      }, {}], 48: [function(e, t, r) {
        for (var s = e("./rng"), n = [], o = {}, i = 0; i < 256; i++) n[i] = (i + 256).toString(16).substr(1), o[n[i]] = i;
        function h(e2, t2) {
          t2 = t2 || 0;
        ...
        function a(e2, t2, r2) {
          ...
          if (i2[6] = 15 & i2[6] | 64, i2[8] = 63 & i2[8] | 128, t2) for (var o2 = 0; o2 < 16; o2++) t2[n2 + o2] = i2[o2];
          return t2 || h(i2);
        }
        e = a;
        e.v1 = function(e2, t2, r2) {
          var n2 = t2 && r2 || 0, i2 = t2 || [], o2 = void 0 !== (e2 = e2 || {}).clockseq ? e2.clockseq : c, s2 = void 0 !== e2.msecs ? e2.msecs : (/* @__PURE__ */ new Date()).getTime(), a2 = void 0 !== e2.nsecs ? e2.nsecs : p + 1;
          if ((r2 = s2 - d + (a2 - p) / 1e4) < 0 && void 0 === e2.clockseq && (o2 = o2 + 1 & 16383), 1e4 <= (a2 = (r2 < 0 || d < s2) && void 0 === e2.nsecs ? 0 : a2)) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          ...
          for (var u = e2.node || f, l = 0; l < 6; l++) i2[n2 + l] = u[l];
          return t2 || h(i2);
        ...
        function _(r2) {
          return function(e2) {
            if (!Array.isArray(e2)) throw new Error("not an array");
            var t2 = [];
        ...
        function E(e2) {
          if (!u.isHexString(e2)) throw new Error("invalid uint256");
          for (; e2.length < 66; ) e2 = "0x0" + e2.substring(2);
          return e2;
        }
        function S(e2) {
          if (null == e2) return "latest";
          if ("earliest" === e2) return "0x0";
          if ("latest" === e2 || "pending" === e2) return e2;
          if ("number" == typeof e2) return u.hexStripZeros(u.hexlify(e2));
          if (u.isHexString(e2)) return u.hexStripZeros(e2);
        ...
        function z(e2) {
          if ("string" == typeof e2) {
            if (20 === u.hexDataLength(e2)) return "address:" + s.getAddress(e2);
            if (e2 = e2.toLowerCase(), 32 === u.hexDataLength(e2)) return "tx:" + e2;
            if (-1 === e2.indexOf(":")) return e2;
          } else {
            if (Array.isArray(e2)) return "filter::" + H(e2);
            if (e2 && "object" == typeof e2) return "filter:" + (e2.address || "") + ":" + H(e2.topics || []);
          }
        ...
        var K, i = (K = v.Provider, i(q, K), q.prototype._doPoll = function() {
          ...
          this.getBlockNumber().then(function(s2) {
            if (u2.polling && (u2._setFastBlockNumber(s2), s2 !== u2._lastBlockNumber)) {
              ...
              for (var e2 = u2._emitted.block + 1; e2 <= s2; e2++) u2.emit("block", e2);
                ...
                switch (t3[0]) {
                  ...
                  case "address":
                    ...
                    u2._balances[n2] && (a2[n2] = u2._balances[n2]), u2.getBalance(n2, "latest").then(function(e4) {
                      ...
                      if (!t4 || !e4.eq(t4)) return u2._balances[n2] = e4, u2.emit(n2, e4), null;
                    }).catch(function(e4) {
                      u2.emit("error", e4);
                    });
                    break;
                  case "filter":
                    ...
                    o2.address || delete o2.address, u2.getLogs(o2).then(function(e4) {
                      if (0 !== e4.length) return e4.forEach(function(e5) {
          ...
          var t2 = this;
          if ("number" != typeof e2 || e2 <= 0 || parseInt(String(e2)) != e2) throw new Error("invalid polling interval");
          ...
          return this.ready.then(function() {
            return r2.perform("getBlockNumber", {}).then(function(e2) {
              var t2 = parseInt(e2);
              if (t2 != e2) throw new Error("invalid response - getBlockNumber");
          ...
          var n2 = this;
          if (null != e2 && 32 !== u.hexDataLength(e2)) throw new Error("invalid response - sendTransaction");
          var t2 = r2;
          ...
          return this.ready.then(function() {
            return c.resolveProperties({ blockHashOrBlockTag: e2 }).then(function(e3) {
              ...
              try {
                var t2 = u.hexlify(e3);
                if (32 === u.hexDataLength(t2)) return m.poll(function() {
            ...
            return c.resolveProperties({ transactionHash: e2 }).then(function(e3) {
              ...
              return m.poll(function() {
                return n2.perform("getTransaction", t2).then(function(e4) {
                  if (null == e4) return null == n2._emitted["t:" + r2] ? null : void 0;
                  var t3 = q.checkTransactionResponse(e4);
                  if (null == t3.blockNumber) t3.confirmations = 0;
                  else if (null == t3.confirmations) return n2._getFastBlockNumber().then(function(e5) {
            ...
            return c.resolveProperties({ transactionHash: e2 }).then(function(e3) {
              ...
              return m.poll(function() {
                return i2.perform("getTransactionReceipt", t2).then(function(e4) {
                  if (null == e4) return null == i2._emitted["t:" + n2] ? null : void 0;
                  if (null != e4.blockHash) {
                    ...
                    if (null == r2.blockNumber) r2.confirmations = 0;
                    else if (null == r2.confirmations) return i2._getFastBlockNumber().then(function(e5) {
          ...
          return this.getNetwork().then(function(e2) {
            ...
            return n2.call(t2).then(function(e3) {
              if (32 !== u.hexDataLength(e3)) return null;
          ...
          var r2 = this;
          if (t2 instanceof Promise) return t2.then(function(e2) {
            return r2.resolveName(e2);
          });
          try {
            return Promise.resolve(s.getAddress(t2));
          } catch (e2) {
            if (u.isHexString(t2)) throw e2;
          }
          ...
          return this._getResolver(e2).then(function(e3) {
            ...
            if ((e3 = e3.substring(2)).length < 64) return null;
            if ((e3 = e3.substring(64)).length < 64) return null;
            var t3 = a.bigNumberify("0x" + e3.substring(0, 64)).toNumber();
            if (2 * t3 > (e3 = e3.substring(64)).length) return null;
          ...
          if (!e2) return this._events.length;
          var t2 = z(e2);
          return this._events.filter(function(e3) {
            return e3.tag === t2;
          }).length;
        ...
        function f(e2) {
          var t2, r2, n2 = [];
          for (t2 in e2) null != e2[t2] && (r2 = a.hexlify(e2[t2]), { gasLimit: true, gasPrice: true, nonce: true, value: true }[t2] && (r2 = a.hexStripZeros(r2)), n2.push(t2 + "=" + r2));
          return n2.join("&");
        }
        function c(e2) {
          if (0 == e2.status && ("No records found" === e2.message || "No transactions found" === e2.message)) return e2.result;
          if (1 == e2.status && "OK" == e2.message) return e2.result;
          var t2 = new Error("invalid response");
          throw t2.result = JSON.stringify(e2), t2;
        }
        function d(e2) {
          if ("2.0" != e2.jsonrpc) throw (t2 = new Error("invalid response")).result = JSON.stringify(e2), t2;
          if (e2.error) {
        ...
        function p(e2) {
          if ("pending" === e2) throw new Error("pending not supported");
        ...
        var y, m = "8FG3JMZ9USS4NTA6YKEKHINU56SEPPVBJR", i = (y = s.BaseProvider, i(g, y), g.prototype.perform = function(e2, t2) {
          ...
          switch (e2) {
            ...
            case "getLogs":
              ...
              try {
                if (t2.filter.fromBlock && (n2 += "&fromBlock=" + p(t2.filter.fromBlock)), t2.filter.toBlock && (n2 += "&toBlock=" + p(t2.filter.toBlock)), t2.filter.blockHash) try {
                ...
                if (t2.filter.address && (n2 += "&address=" + t2.filter.address), t2.filter.topics && 0 < t2.filter.topics.length) {
                  if (1 < t2.filter.topics.length) throw new Error("unsupported topic format");
                  var a2 = t2.filter.topics[0];
                  if ("string" != typeof a2 || 66 !== a2.length) throw new Error("unsupported topic0 format");
                  n2 += "&topic0=" + a2;
                }
              } catch (e3) {
                return Promise.reject(e3);
        ...
        function h(e2) {
          var t2, r2 = this;
          if (0 === e2.length) throw new Error("no providers");
          ...
          return this.sendUncheckedTransaction(e2).then(function(t2) {
            return p.poll(function() {
              return r2.provider.getTransaction(t2).then(function(e3) {
                if (null !== e3) return r2.provider._wrapTransaction(e3, t2);
              });
        ...
        function _(e2, t2, r2) {
          ...
          if (u.checkNew(n2, _), e2 !== v) throw new Error("do not call the JsonRpcSigner constructor directly; use provider.getSigner");
        ...
        var M, A = { chainId: true, data: true, gasLimit: true, gasPrice: true, nonce: true, to: true, value: true }, E = (M = s.BaseProvider, i(S, M), S.prototype.getSigner = function(e2) {
          ...
          null == this._pendingFilter && (n2 = (r2 = this).send("eth_newPendingTransactionFilter", []), (this._pendingFilter = n2).then(function(t2) {
            return function e2() {
              r2.send("eth_getFilterChanges", [t2]).then(function(e3) {
                if (r2._pendingFilter != n2) return null;
          ...
          if (e2) for (var n2 in e2) e2[n2] && (t2[n2] = true);
        ...
        function b(e2, t2) {
          ...
          if (o2.parent) throw new Error("unexpected eof");
        ...
        r.parseParamType = function(e2) {
          ...
          if ("string" == typeof e2) return "event " === (e2 = (e2 = (e2 = e2.replace(/\s/g, " ")).replace(/\(/g, " (").replace(/\)/g, ") ").replace(/\s+/g, " ")).trim()).substring(0, 6) ? function(e3) {
            var t2 = { anonymous: false, inputs: [], name: "", type: "event" }, r2 = e3.match(m);
            if (!r2) throw new Error("invalid event: " + e3);
            ...
            }), t2.name && !t2.name.match(g)) throw new Error('invalid identifier: "' + t2.name + '"');
            return t2;
            ...
            if (1 !== r2.length) {
              if (2 < r2.length) throw new Error("invalid signature");
              if (!r2[1].match(/^[0-9]+$/)) throw new Error("invalid signature gas");
              t2.gas = u.bigNumberify(r2[1]), e3 = r2[0];
            }
            if (!(e3 = (r2 = e3.split(" returns "))[0].match(m))) throw new Error("invalid signature");
            if (t2.name = e3[1].trim(), !t2.name.match(g)) throw new Error('invalid identifier: "' + e3[1] + '"');
            if (re(e3[2]).forEach(function(e4) {
              ...
              r2 = r2[1].match(m);
              if ("" != r2[1].trim() || "" != r2[3].trim()) throw new Error("unexpected tokens");
              re(r2[2]).forEach(function(e4) {
                t2.outputs.push(b(e4));
              });
            }
            if ("constructor" === t2.name) {
              if (t2.type = "constructor", t2.outputs.length) throw new Error("constructor may not have outputs");
        ...
        var S, k = (i(N, S = _), N.prototype.encode = function(e2) {
          ...
          if (t2 > e2.length) throw new Error("invalid null");
        ...
        var x, P = (i(I, x = _), I.prototype.encode = function(t2) {
          try {
            ...
            if (this.signed) {
              ...
              if (e2.gt(r2)) throw new Error("out-of-bounds");
              if (r2 = r2.add(s.One).mul(s.NegativeOne), e2.lt(r2)) throw new Error("out-of-bounds");
            } else if (e2.lt(s.Zero) || e2.gt(s.MaxUint256.maskn(8 * this.size))) throw new Error("out-of-bounds");
        ...
        var L, B = (i(D, L = _), D.prototype.encode = function(t2) {
          ...
          try {
            ...
            if (r2.length !== this.length) throw new Error("incorrect data length");
            e2.set(r2);
          } catch (e3) {
        ...
        var X, $ = (i(Q, X = _), Q.prototype.encode = function(e2) {
          ...
          for (var n2 = [], i2 = 0; i2 < e2.length; i2++) n2.push(this.coder);
          ...
          for (var o2 = [], s2 = 0; s2 < n2; s2++) o2.push(new A(this.coder));
          t2 = J(o2, e2, t2);
        ...
        function re(e2) {
          ...
          for (var t2 = [], r2 = "", n2 = 0, i2 = 0; i2 < e2.length; i2++) {
            var o2 = e2[i2];
            if ("," === o2 && 0 === n2) t2.push(r2), r2 = "";
            else if (r2 += o2, "(" === o2) n2++;
            else if (")" === o2 && -1 === --n2) throw new Error("unbalanced parenthsis");
          }
        ...
        function ie(e2, t2) {
          var r2 = ne[t2.type];
          if (r2) return new r2(e2, t2.name);
          r2 = t2.type.match(p);
          if (r2) return (0 === (o2 = parseInt(r2[2] || "256")) || 256 < o2 || o2 % 8 != 0) && l.throwError("invalid " + r2[1] + " bit length", l.INVALID_ARGUMENT, { arg: "param", value: t2 }), new P(e2, o2 / 8, "int" === r2[1], t2.name);
          var n2, i2, r2 = t2.type.match(d);
          if (r2) return (0 === (o2 = parseInt(r2[1])) || 32 < o2) && l.throwError("invalid bytes length", l.INVALID_ARGUMENT, { arg: "param", value: t2 }), new B(e2, o2, t2.name);
        ...
        function l(e2) {
          ...
          for (var t2 = (e2 = e2.toLowerCase()).substring(2).split(""), r2 = new Uint8Array(40), n2 = 0; n2 < 40; n2++) r2[n2] = t2[n2].charCodeAt(0);
          for (var r2 = o.arrayify(s.keccak256(r2)), i2 = 0; i2 < 40; i2 += 2) 8 <= r2[i2 >> 1] >> 4 && (t2[i2] = t2[i2].toUpperCase()), 8 <= (15 & r2[i2 >> 1]) && (t2[i2 + 1] = t2[i2 + 1].toUpperCase());
          return "0x" + t2.join("");
        }
        ...
        function p(e2) {
          ...
          for (e2.split("").forEach(function(e3) {
            t2 += h[e3];
          }); t2.length >= d; ) var r2 = t2.substring(0, d), t2 = parseInt(r2, 10) % 97 + t2.substring(r2.length);
          for (var n2 = String(98 - parseInt(t2, 10) % 97); n2.length < 2; ) n2 = "0" + n2;
          return n2;
        }
        function y(e2) {
          var t2 = null;
          if ("string" != typeof e2 && u.throwError("invalid address", u.INVALID_ARGUMENT, { arg: "address", value: e2 }), e2.match(/^(0x)?[0-9a-fA-F]{40}$/)) t2 = l(e2 = "0x" !== e2.substring(0, 2) ? "0x" + e2 : e2), e2.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && t2 !== e2 && u.throwError("bad address checksum", u.INVALID_ARGUMENT, { arg: "address", value: e2 });
          else if (e2.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
            for (e2.substring(2, 4) !== p(e2) && u.throwError("bad icap checksum", u.INVALID_ARGUMENT, { arg: "address", value: e2 }), t2 = new i.default.BN(e2.substring(4), 36).toString(16); t2.length < 40; ) t2 = "0" + t2;
            t2 = l("0x" + t2);
          } else u.throwError("invalid address", u.INVALID_ARGUMENT, { arg: "address", value: e2 });
          return t2;
        }
        r.getAddress = y, r.getIcapAddress = function(e2) {
          for (var t2 = new i.default.BN(y(e2).substring(2), 16).toString(36).toUpperCase(); t2.length < 30; ) t2 = "0" + t2;
          return "XE" + p("XE00" + t2) + t2;
        }, r.getContractAddress = function(e2) {
          if (!e2.from) throw new Error("missing from address");
          var t2 = e2.nonce;
        ...
        t.exports = { decode: function(e2) {
          e2 = atob(e2);
          for (var t2 = [], r2 = 0; r2 < e2.length; r2++) t2.push(e2.charCodeAt(r2));
        ...
        var l = e("./bytes"), n = e("./properties"), i = (o.prototype.encode = function(e2) {
          ...
          for (var r2 = [0], n2 = 0; n2 < t2.length; ++n2) {
            for (var i2 = t2[n2], o2 = 0; o2 < r2.length; ++o2) i2 += r2[o2] << 8, r2[o2] = i2 % this.base, i2 = i2 / this.base | 0;
            for (; 0 < i2; ) r2.push(i2 % this.base), i2 = i2 / this.base | 0;
          }
          for (var s = "", a = 0; 0 === t2[a] && a < t2.length - 1; ++a) s += this._leader;
          for (var u = r2.length - 1; 0 <= u; --u) s += this.alphabet[r2[u]];
          return s;
        }, o.prototype.decode = function(e2) {
          if ("string" != typeof e2) throw new TypeError("Expected String");
          var t2 = [];
          if (0 === e2.length) return new Uint8Array(t2);
          t2.push(0);
          for (var r2 = 0; r2 < e2.length; r2++) {
            var n2 = this._alphabetMap[e2[r2]];
            if (void 0 === n2) throw new Error("Non-base" + this.base + " character");
            for (var i2 = n2, o2 = 0; o2 < t2.length; ++o2) i2 += t2[o2] * this.base, t2[o2] = 255 & i2, i2 >>= 8;
            for (; 0 < i2; ) t2.push(255 & i2), i2 >>= 8;
          }
          for (var s = 0; e2[s] === this._leader && s < e2.length - 1; ++s) t2.push(0);
        ...
        function o(e2) {
          ...
          for (var t2 = 0; t2 < e2.length; t2++) this._alphabetMap[e2.charAt(t2)] = t2;
        }
        ...
        function y(e2) {
          if (u.checkNew(this, y), a.setType(this, "BigNumber"), "string" == typeof e2) s.isHexString(e2) ? a.defineReadOnly(this, "_hex", e2 = "0x" == e2 ? "0x0" : e2) : "-" === e2[0] && s.isHexString(e2.substring(1)) ? a.defineReadOnly(this, "_hex", e2) : e2.match(/^-?[0-9]*$/) ? a.defineReadOnly(this, "_hex", h(new o.default.BN(e2 = "" == e2 ? "0" : e2))) : u.throwError("invalid BigNumber string value", u.INVALID_ARGUMENT, { arg: "value", value: e2 });
        ...
        function l(e2) {
          if (!e2 || parseInt(String(e2.length)) != e2.length || "string" == typeof e2) return false;
          for (var t2 = 0; t2 < e2.length; t2++) {
            var r2 = e2[t2];
            if (r2 < 0 || 256 <= r2 || parseInt(String(r2)) != r2) return false;
          }
          return true;
        }
        function h(e2) {
          if (null == e2 && s.throwError("cannot convert null value to array", s.INVALID_ARGUMENT, { arg: "value", value: e2 }), "string" != typeof (e2 = a(e2) ? e2.toHexString() : e2)) return l(e2) ? u(new Uint8Array(e2)) : (s.throwError("invalid arrayify value", null, { arg: "value", value: e2, type: typeof e2 }), null);
          ...
          for (var r2 = [], n2 = 0; n2 < e2.length; n2 += 2) r2.push(parseInt(e2.substr(n2, 2), 16));
        ...
        function i(e2) {
          ...
          for (var o2 = new Uint8Array(r2), s2 = 0, n2 = 0; n2 < t2.length; n2++) o2.set(t2[n2], s2), s2 += t2[n2].length;
          return u(o2);
        }
        function o(e2, t2) {
        ...
        function c(e2) {
          ...
          if ("number" == typeof e2) {
            ...
            for (var t2 = ""; e2; ) t2 = f[15 & e2] + t2, e2 = Math.floor(e2 / 16);
        ...
        function d(e2, t2) {
          for (o(e2) || s.throwError("invalid hex string", s.INVALID_ARGUMENT, { arg: "value", value: e2 }); e2.length < 2 * t2 + 2; ) e2 = "0x0" + e2.substring(2);
          return e2;
        }
        function p(e2) {
          ...
          if ((i2 = e2) && null != i2.r && null != i2.s) {
            ...
            e2 = h(e2);
            if (65 !== e2.length) throw new Error("invalid signature");
        ...
        r.hexlify = c, r.hexDataLength = function(e2) {
          ...
          for (o(e2) || s.throwError("invalid hex string", s.INVALID_ARGUMENT, { arg: "value", value: e2 }); 3 < e2.length && "0x0" === e2.substring(0, 3); ) e2 = "0x" + e2.substring(3);
          return e2;
        ...
        var M = (Object.defineProperty(A.prototype, "extendedKey", { get: function() {
          ...
          if (4294967295 < e2) throw new Error("invalid index - " + String(e2));
          var t2 = this.path;
          t2 && (t2 += "/" + (e2 & ~g));
          ...
          } else r2.set(c.arrayify(this.publicKey));
          for (var n2 = 24; 0 <= n2; n2 -= 8) r2[33 + (n2 >> 3)] = e2 >> 24 - n2 & 255;
          ...
          var t2 = e2.split("/");
          if (0 === t2.length || "m" === t2[0] && 0 !== this.depth) throw new Error("invalid path - " + e2);
          "m" === t2[0] && t2.shift();
          for (var r2 = this, n2 = 0; n2 < t2.length; n2++) {
            var i2 = t2[n2];
            if (i2.match(/^[0-9]+'$/)) {
              var o2 = parseInt(i2.substring(0, i2.length - 1));
              if (g <= o2) throw new Error("invalid path index - " + i2);
              r2 = r2._derive(g + o2);
            } else {
              if (!i2.match(/^[0-9]+$/)) throw new Error("invalid path component - " + i2);
              o2 = parseInt(i2);
              if (g <= o2) throw new Error("invalid path index - " + i2);
              r2 = r2._derive(o2);
            }
        ...
        function A(e2, t2, r2, n2, i2, o2, s2, a2, u2) {
          if (h.checkNew(this, A), e2 !== _) throw new Error("HDNode constructor cannot be called directly");
        ...
        function E(e2, t2) {
          e2 = c.arrayify(e2);
          if (e2.length < 16 || 64 < e2.length) throw new Error("invalid seed");
        ...
        function k(e2, t2) {
          ...
          var r2 = t2.split(e2);
          if (r2.length % 3 != 0) throw new Error("invalid mnemonic");
          for (var n2 = c.arrayify(new Uint8Array(Math.ceil(11 * r2.length / 8))), i2 = 0, o2 = 0; o2 < r2.length; o2++) {
            ...
            if (-1 === s2) throw new Error("invalid mnemonic");
            for (var a2 = 0; a2 < 11; a2++) s2 & 1 << 10 - a2 && (n2[i2 >> 3] |= 1 << 7 - i2 % 8), i2++;
          }
          var u2 = 32 * r2.length / 3, l2 = v(r2.length / 3), e2 = c.arrayify(y.sha256(n2.slice(0, u2 / 8)))[0];
          if ((e2 &= l2) != (n2[n2.length - 1] & l2)) throw new Error("invalid checksum");
          return c.hexlify(n2.slice(0, u2 / 8));
        }
        function N(e2, t2) {
          if ((e2 = c.arrayify(e2)).length % 4 != 0 || e2.length < 16 || 32 < e2.length) throw new Error("invalid entropy");
          for (var r2 = [0], n2 = 11, i2 = 0; i2 < e2.length; i2++) 8 < n2 ? (r2[r2.length - 1] <<= 8, r2[r2.length - 1] |= e2[i2], n2 -= 8) : (r2[r2.length - 1] <<= n2, r2[r2.length - 1] |= e2[i2] >> 8 - n2, r2.push(e2[i2] & (1 << 8 - n2) - 1), n2 += 3);
        ...
        var s, a = e("./address"), f = e("./abi-coder"), u = e("./bignumber"), c = e("./bytes"), l = e("./hash"), h = e("./keccak256"), d = e("./properties"), p = o(e("../errors")), y = function(e2) {
          ...
          for (var t2 in d.setType(this, "Description"), e2) d.defineReadOnly(this, t2, d.deepCopy(e2[t2], true));
          Object.freeze(this);
        ...
        var E, S = (i(k, E = e), k.prototype.encodeTopics = function(e2) {
          ...
          }); i2.length && null === i2[i2.length - 1]; ) i2.pop();
          return i2;
        ...
        C.prototype.parseTransaction = function(e2) {
          ...
          for (t2 in this.functions) if (-1 !== t2.indexOf("(")) {
          ...
          for (var t2 in this.events) if (-1 !== t2.indexOf("(")) {
            t2 = this.events[t2];
            if (!t2.anonymous && t2.topic === e2.topics[0]) return new T({ decode: t2.decode, name: t2.name, signature: t2.signature, topic: t2.topic, values: t2.decode(e2.data, e2.topics) });
          }
          return null;
        ...
        function C(t2) {
          if (p.checkNew(this, C), "string" == typeof t2) {
            ...
            if (!Array.isArray(t2)) return p.throwError("invalid abi", p.INVALID_ARGUMENT, { arg: "abi", value: t2 }), null;
          }
        ...
        r.getNetwork = function(e2) {
          ...
          if ("number" == typeof e2) {
            for (var t2 in a) {
              t2 = a[t2];
              if (t2.chainId === e2) return { name: t2.name, chainId: t2.chainId, ensAddress: t2.ensAddress || null, _defaultProvider: t2._defaultProvider || null };
            }
            return { chainId: e2, name: "unknown" };
          }
          if ("string" != typeof e2) return (r2 = a[e2.name]) ? (0 !== e2.chainId && e2.chainId !== r2.chainId && i.throwError("network chainId mismatch", i.INVALID_ARGUMENT, { arg: "network", value: e2 }), { name: e2.name, chainId: r2.chainId, ensAddress: e2.ensAddress || r2.ensAddress || null, _defaultProvider: e2._defaultProvider || r2._defaultProvider || null }) : ("number" != typeof e2.chainId && i.throwError("invalid network chainId", i.INVALID_ARGUMENT, { arg: "network", value: e2 }), e2);
          var r2 = a[e2];
        ...
        r.pbkdf2 = function(e2, t2, r2, n, i) {
          ...
          for (var f = 1; f <= u; f++) {
            ...
            for (var d = 1; d < r2; d++) for (var c = v.computeHmac(i, e2, c), p = 0; p < o; p++) a[p] ^= c[p];
        ...
        r.deepCopy = function t2(e2, r2) {
          ...
          if ("object" == typeof e2) {
            if (a(e2, "BigNumber")) return e2;
            if (a(e2, "Description")) return e2;
            if (a(e2, "Indexed")) return e2;
            var i2, n2 = {};
            for (i2 in e2) {
              var o = e2[i2];
        ...
        !(function(i) {
          !(function() {
            ...
            function n(e3) {
              if (e3 <= 0 || 1024 < e3 || parseInt(String(e3)) != e3) throw new Error("invalid length");
            ...
            r && r.getRandomValues || (console.log("WARNING: Missing strong random number source; using weak randomBytes"), r = { getRandomValues: function(e3) {
              for (var t2 = 0; t2 < 20; t2++) for (var r2 = 0; r2 < e3.length; r2++) t2 ? e3[r2] ^= Math.trunc(256 * Math.random()) : e3[r2] = Math.trunc(256 * Math.random());
              return e3;
        ...
        var i = e("./bytes");
        function o(e2) {
          for (var t2 = []; e2; ) t2.unshift(255 & e2), e2 >>= 8;
          return t2;
        }
        function s(e2, t2, r2) {
          for (var n = 0, i2 = 0; i2 < r2; i2++) n = 256 * n + e2[t2 + i2];
          return n;
        }
        function a(e2, t2, r2, n) {
          for (var i2 = []; r2 < t2 + 1 + n; ) {
            var o2 = u(e2, r2);
            if (i2.push(o2.result), t2 + 1 + n < (r2 += o2.consumed)) throw new Error("invalid rlp");
          }
          return { consumed: 1 + n, result: i2 };
        }
        function u(e2, t2) {
          if (0 === e2.length) throw new Error("invalid rlp data");
          if (248 <= e2[t2]) {
            if (t2 + 1 + (r2 = e2[t2] - 247) > e2.length) throw new Error("too short");
            if (t2 + 1 + r2 + (n = s(e2, t2 + 1, r2)) > e2.length) throw new Error("to short");
            return a(e2, t2, t2 + 1 + r2, r2 + n);
          }
          if (192 <= e2[t2]) {
            if (t2 + 1 + (n = e2[t2] - 192) > e2.length) throw new Error("invalid rlp data");
            return a(e2, t2, t2 + 1, n);
          }
          if (184 <= e2[t2]) {
            var r2;
            if (t2 + 1 + (r2 = e2[t2] - 183) > e2.length) throw new Error("invalid rlp data");
            if (t2 + 1 + r2 + (n = s(e2, t2 + 1, r2)) > e2.length) throw new Error("invalid rlp data");
            return { consumed: 1 + r2 + n, result: i.hexlify(e2.slice(t2 + 1 + r2, t2 + 1 + r2 + n)) };
          }
          if (128 <= e2[t2]) {
            var n;
            if (t2 + 1 + (n = e2[t2] - 128) > e2.length) throw new Error("invalid rlp data");
        ...
        r.encode = function(e2) {
          ...
          if ((e2 = u(t2, 0)).consumed !== t2.length) throw new Error("invalid rlp data");
          return e2.result;
        };
        ...
        function y(e2, t2) {
          e2 = s.arrayify(e2);
          if (32 !== e2.length) return 33 === e2.length ? t2 ? s.hexlify(e2) : "0x" + c().keyFromPublic(e2).getPublic(false, "hex") : 65 === e2.length ? t2 ? "0x" + c().keyFromPublic(e2).getPublic(true, "hex") : s.hexlify(e2) : (h.throwError("invalid public or private key", h.INVALID_ARGUMENT, { arg: "key", value: "[REDACTED]" }), null);
          e2 = new d(e2);
        ...
        function N(e2, t2) {
          for (e2 = String(e2); e2.length < t2; ) e2 = "0" + e2;
          return e2;
        }
        function x(e2) {
        ...
        function p(e2, t2) {
          for (var r2 = e2, n2 = t2.toLowerCase().split("/"), i2 = 0; i2 < n2.length; i2++) {
            var o, s2 = null;
            for (o in r2) if (o.toLowerCase() === n2[i2]) {
              s2 = r2[o];
              break;
            }
        ...
        r.decryptCrowdsale = function(e2, t2) {
          ...
          if (!(e2 = d(p(r2, "encseed"))) || e2.length % 16 != 0) throw new Error("invalid encseed");
          for (var r2 = c.pbkdf2(t2, t2, 2e3, 32, "sha256").slice(0, 16), t2 = e2.slice(0, 16), e2 = e2.slice(16), t2 = new w.default.ModeOfOperation.cbc(r2, t2), i2 = E.arrayify(t2.decrypt(e2)), i2 = w.default.padding.pkcs7.strip(i2), o = "", s2 = 0; s2 < i2.length; s2++) o += String.fromCharCode(i2[s2]);
          if (e2 = u.toUtf8Bytes(o), (e2 = new A.SigningKey(S.keccak256(e2))).address !== n2) throw new Error("corrupt crowdsale wallet");
          return e2;
        }, r.decrypt = function(e2, t2, u2) {
          function l(e3, t3) {
            var r2 = d(p(h, "crypto/ciphertext"));
            if (E.hexlify((o = e3.slice(16, 32), S.keccak256(E.concat([o, r2])))).substring(2) !== p(h, "crypto/mac").toLowerCase()) return t3(new Error("invalid password")), null;
            var n2 = function(e4, t4) {
              if ("aes-128-ctr" !== p(h, "crypto/cipher")) return null;
            ...
            if (!n2) return t3(new Error("unsupported cipher")), null;
            var o = new A.SigningKey(n2);
            if (h.address && o.address !== a.getAddress(h.address)) return t3(new Error("address mismatch")), null;
            if (r2 = p(h, "x-ethers/locale"), "0.1" === p(h, "x-ethers/version") && (null == r2 || "en" === r2)) {
              ...
              if (r2.privateKey != E.hexlify(n2)) return t3(new Error("mnemonic mismatch")), null;
          ...
          return new Promise(function(n2, i2) {
            ...
            if (e3 && "string" == typeof e3) if ("scrypt" === e3.toLowerCase()) {
              ...
              r2 && o && s2 ? 0 == (r2 & r2 - 1) ? 32 === (a2 = parseInt(p(h, "crypto/kdfparams/dklen"))) ? (u2 && u2(0), _.default(f, t3, r2, o, s2, 64, function(e4, t4, r3) {
                if (e4) e4.progress = t4, i2(e4);
                else if (r3) {
                  r3 = E.arrayify(r3);
                  r3 = l(r3, i2);
                  r3 && (u2 && u2(1), n2(r3));
                } else if (u2) return u2(t4);
              ...
              if ("hmac-sha256" === e3) s2 = "sha256";
              else {
                if ("hmac-sha512" !== e3) return void i2(new Error("unsupported prf"));
                s2 = "sha512";
              }
            ...
            } else i2(new Error("unsupported key-derivation function"));
            else i2(new Error("unsupported key-derivation function"));
          });
        }, r.encrypt = function(e2, t2, u2, l) {
          "function" != typeof u2 || l || (l = u2, u2 = {}), u2 = u2 || {};
          var h = null;
          if (32 !== (h = A.SigningKey.isSigningKey(e2) ? E.arrayify(e2.privateKey) : E.arrayify(e2)).length) throw new Error("invalid private key");
          var r2 = x(t2), f = null;
          if (u2.entropy && (f = E.arrayify(u2.entropy)), u2.mnemonic) if (f) {
            if (s.entropyToMnemonic(f) !== u2.mnemonic) throw new Error("entropy and mnemonic mismatch");
          } else f = E.arrayify(s.mnemonicToEntropy(u2.mnemonic, u2.wordlist));
          var c2 = u2.path;
          f && !c2 && (c2 = s.defaultPath);
          var d2 = (d2 = u2.client) || "ethers.js", p2 = null, p2 = u2.salt ? E.arrayify(u2.salt) : k.randomBytes(32), y = null;
          if (u2.iv) {
            if (16 !== (y = E.arrayify(u2.iv)).length) throw new Error("invalid iv");
          } else y = k.randomBytes(16);
          var m = null;
          if (u2.uuid) {
            if (16 !== (m = E.arrayify(u2.uuid)).length) throw new Error("invalid uuid");
        ...
        function o(e2, r2) {
          if (e2.length != r2.length) throw new Error("type/value count mismatch");
          var n2 = [];
          return e2.forEach(function(e3, t2) {
            n2.push(function t3(e4, r3, n3) {
              ...
              var i2 = e4.match(c);
              if (i2) {
                if ((o2 = parseInt(i2[2] || "256")) % 8 != 0 || 0 === o2 || 256 < o2) throw new Error("invalid number type - " + e4);
                return n3 && (o2 = 256), r3 = u.bigNumberify(r3).toTwos(o2), l.padZeros(r3, o2 / 8);
              }
              if (i2 = e4.match(f)) {
                var o2 = parseInt(i2[1]);
                if (String(o2) != i2[1] || 0 === o2 || 32 < o2) throw new Error("invalid number type - " + e4);
                if (l.arrayify(r3).byteLength !== o2) throw new Error("invalid value for " + e4);
                return n3 ? l.arrayify((r3 + p).substring(0, 66)) : r3;
              }
              if ((i2 = e4.match(d)) && Array.isArray(r3)) {
                var s = i2[1];
                if (parseInt(i2[2] || String(r3.length)) != r3.length) throw new Error("invalid value for " + e4);
                var a = [];
        ...
        r.serialize = function(r2, e2) {
          ...
          if (6 === n2.length) return t2;
          try {
            t2.v = u.bigNumberify(n2[6]).toNumber();
          } catch (e3) {
            return o.info(e3), t2;
          }
          if (t2.r = l.hexZeroPad(n2[7], 32), t2.s = l.hexZeroPad(n2[8], 32), u.bigNumberify(t2.r).isZero() && u.bigNumberify(t2.s).isZero()) t2.chainId = t2.v, t2.v = 0;
          else {
        ...
        function h(e2) {
          ...
          if (!t2 && "number" == typeof e2 && parseInt(String(e2)) == e2 && 0 <= e2 && e2 <= 256) {
            for (var r2 = "1", n2 = 0; n2 < e2; n2++) r2 += "0";
            t2 = l(r2);
          }
          return t2 || s.throwError("invalid unitType", s.INVALID_ARGUMENT, { argument: "name", value: e2 }), t2;
        }
        function f(e2, t2) {
          for (var r2 = h(t2), t2 = (e2 = a.bigNumberify(e2)).lt(o.Zero), n2 = (e2 = t2 ? e2.mul(o.NegativeOne) : e2).mod(r2.tenPower).toString(); n2.length < r2.decimals; ) n2 = "0" + n2;
          n2 = n2.match(/^([0-9]*[1-9]|0)(0*)/)[1];
          return e2 = e2.div(r2.tenPower).toString() + "." + n2, e2 = t2 ? "-" + e2 : e2;
        }
        function c(e2, t2) {
          var r2 = h(t2 = null == t2 ? 18 : t2);
          if ("string" == typeof e2 && e2.match(/^-?[0-9.,]+$/) || s.throwError("invalid decimal value", s.INVALID_ARGUMENT, { arg: "value", value: e2 }), 0 === r2.decimals) return a.bigNumberify(e2);
          ...
          for ((i2 = i2 || "0").length > r2.decimals && s.throwError("underflow occurred", s.NUMERIC_FAULT, { operation: "division", fault: "underflow" }); i2.length < r2.decimals; ) i2 += "0";
        ...
        i = "1", ["wei", "kwei", "Mwei", "Gwei", "szabo", "finney", "ether"].forEach(function(e2) {
          ...
          var r2 = t2[0], n2 = "";
          for ("-" === r2.substring(0, 1) && (n2 = "-", r2 = r2.substring(1)); "0" === r2.substring(0, 1); ) r2 = r2.substring(1);
        ...
        function i(e2, t2) {
          ...
          for (var r2 = [], n2 = 0; n2 < e2.length; n2++) {
            ...
            if (i2 < 128) r2.push(i2);
            else if (i2 < 2048) r2.push(i2 >> 6 | 192), r2.push(63 & i2 | 128);
            else if (55296 == (64512 & i2)) {
              n2++;
              var o2 = e2.charCodeAt(n2);
              if (n2 >= e2.length || 56320 != (64512 & o2)) throw new Error("invalid utf-8 string");
              r2.push((i2 = 65536 + ((1023 & i2) << 10) + (1023 & o2)) >> 18 | 240), r2.push(i2 >> 12 & 63 | 128), r2.push(i2 >> 6 & 63 | 128), r2.push(63 & i2 | 128);
            } else r2.push(i2 >> 12 | 224), r2.push(i2 >> 6 & 63 | 128), r2.push(63 & i2 | 128);
          }
        ...
        function o(e2, t2) {
          ...
          for (var r2 = "", n2 = 0; n2 < e2.length; ) {
            ...
            if (i2 >> 7 != 0) {
              var o2 = null, s2 = null;
              if (192 == (224 & i2)) o2 = 1, s2 = 127;
              else if (224 == (240 & i2)) o2 = 2, s2 = 2047;
              else {
                if (240 != (248 & i2)) {
                  if (t2) continue;
                  if (128 == (192 & i2)) throw new Error("invalid utf8 byte sequence; unexpected continuation byte");
                  throw new Error("invalid utf8 byte sequence; invalid prefix");
                }
                o2 = 3, s2 = 65535;
              }
              if (n2 + o2 > e2.length) {
                if (!t2) throw new Error("invalid utf8 byte sequence; too short");
                ...
                if (null !== a2) if (a2 <= s2) {
                  if (!t2) throw new Error("invalid utf8 byte sequence; overlong");
                } else if (1114111 < a2) {
                  if (!t2) throw new Error("invalid utf8 byte sequence; out-of-range");
                } else if (55296 <= a2 && a2 <= 57343) {
                  if (!t2) throw new Error("invalid utf8 byte sequence; utf-16 surrogate");
                } else a2 <= 65535 ? r2 += String.fromCharCode(a2) : (a2 -= 65536, r2 += String.fromCharCode(55296 + (a2 >> 10 & 1023), 56320 + (1023 & a2)));
                else if (!t2) throw new Error("invalid utf8 byte sequence; invalid continuation byte");
              }
        ...
        (e = s = r.UnicodeNormalizationForm || (r.UnicodeNormalizationForm = {})).current = "", e.NFC = "NFC", e.NFD = "NFD", e.NFKC = "NFKC", e.NFKD = "NFKD", r.toUtf8Bytes = i, r.toUtf8String = o, r.formatBytes32String = function(e2) {
          if (31 < (e2 = i(e2)).length) throw new Error("bytes32 string must be less than 32 bytes");
          return h.hexlify(h.concat([e2, n.HashZero]).slice(0, 32));
        }, r.parseBytes32String = function(e2) {
          var t2 = h.arrayify(e2);
          if (32 !== t2.length) throw new Error("invalid bytes32 - not 32 bytes long");
          if (0 !== t2[31]) throw new Error("invalid bytes32 string - no null terminator");
          for (var r2 = 31; 0 === t2[r2 - 1]; ) r2--;
        ...
        r.fetchJson = function(e2, a, u) {
          ...
          if ("string" == typeof e2) l = e2;
          else if ("object" == typeof e2) {
            if (null == e2.url && c.throwError("missing URL", c.MISSING_ARGUMENT, { arg: "url" }), l = e2.url, "number" == typeof e2.timeout && 0 < e2.timeout && (h = e2.timeout), e2.headers) for (var n2 in e2.headers) r2[n2.toLowerCase()] = { key: n2, value: String(e2.headers[n2]) };
          ...
          !(function() {
            ...
            o.check = function(e4) {
              for (var t2 = [], r2 = 0; r2 < 2048; r2++) {
                ...
                if (r2 !== e4.getWordIndex(n2)) return "0x";
                t2.push(n2);
              }
              return i.id(t2.join("\n") + "\n");
            };
        ...
        var s, a = e("./utils/bytes"), u = e("./utils/hash"), l = e("./utils/hdnode"), h = e("./utils/json-wallet"), f = e("./utils/keccak256"), c = e("./utils/properties"), d = e("./utils/random-bytes"), p = o(e("./utils/secret-storage")), y = e("./utils/signing-key"), m = e("./utils/transaction"), g = e("./abstract-signer"), v = e("./providers/abstract-provider"), b = o(e("./errors")), i = (s = g.Signer, i(w, s), Object.defineProperty(w.prototype, "address", { get: function() {
          ...
          if ("function" != typeof t2 || r2 || (r2 = t2, t2 = {}), r2 && "function" != typeof r2) throw new Error("invalid callback");
          ...
          else if (h.isSecretStorageWallet(e2)) return p.decrypt(e2, t2, r2).then(function(e3) {
            return new w(e3);
          });
        ...
        function l(e2) {
          if (null == u && (u = a.replace(/([A-Z])/g, " $1").toLowerCase().substring(1).split(" "), "0x3c8acc1e7b08d8e76f9fda015ef48dc8c710a73cb7e0f77b2c18a9b5a7adde60" !== s.check(e2))) throw u = null, new Error("BIP39 Wordlist for en (English) FAILED");
        }
        function h() {
...
export default require_ethers_min();
